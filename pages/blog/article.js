...
// ─── Réagir sur Instagram (remplace l'ancien module commentaires) ──
// Fallback si l'article n'a pas de champ instagramUrl renseigné dans blog-data.js
...
function renderArticle(article) {
    ...
    container.innerHTML = `
        ...
        <section class="mt-16 pt-10 border-t border-slate-800 text-center" id="instagramCta">
            <p class="text-xs text-slate-500 uppercase font-bold tracking-widest mb-4">Une réaction ?</p>
            <a href="${escapeHtml(article.instagramUrl || INSTAGRAM_PROFILE_URL)}"
               target="_blank" rel="noopener noreferrer"
               class="hud-btn hud-btn-primary inline-flex items-center justify-center gap-2" style="width:auto;padding:0.75rem 1.75rem;">
